[[https://melpa.org/#/numeri][file:https://melpa.org/packages/numeri-badge.svg]] [[https://stable.melpa.org/#/numeri][file:https://stable.melpa.org/packages/numeri-badge.svg]]

* numeri

Numeri is an Emacs Lisp package to support the conversion of [[https://en.wikipedia.org/wiki/Hindu–Arabic_numeral_system][Hindu-Arabic numbers]] to [[https://en.wikipedia.org/wiki/Roman_numerals][Roman]] and vice-versa. It is built off utility functions provided by the reStructuredText (~rst~) package. Only integer numbers are supported.
